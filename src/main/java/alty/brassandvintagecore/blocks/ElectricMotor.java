...
public class ElectricMotor extends BlockContainer implements IHasModel{
	
	public static String NAME = "electric_motor";
		...
		if(HandScrewgun.isWrench(playerIn.getHeldItem(hand), worldIn.isRemote)){
			if(!worldIn.isRemote){
				...
				if(te instanceof TileElectricMotor){
					((TileElectricMotor) te).disconnect();
				}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta){
		return new TileElectricMotor(EnumFacing.getFront(meta));
