package alty.brassandvintagecore.mts;

import alty.brassandvintagecore.transformers.MTSSteamEngineTransformer;
...
public class PartSteamEngine_Car extends MTSSteamEngineTransformer {

	
	//This is pretty much just the default engine class from MTS, credits to Don Bruce for coding it
	private double engineForce;
	private final EntityVehicleG_Car car;
	
	
	public PartSteamEngine_Car(EntityVehicleE_Powered vehicle, PackPart packPart, String partName,
